...
export function InstallButton({ className = "" }) {
  ...
  return (
    <button
      onClick={handleInstall}
      className={`inline-flex items-center gap-1.5 text-sm font-medium bg-gradient-to-r from-court-500 to-court-600 text-white rounded-lg px-3 py-1.5 hover:from-court-600 hover:to-court-700 transition-all shadow-sm hover:shadow-md ${className}`}
    >
