    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-3">Loading game...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        <p className="text-sm text-gray-500">
          Hey <span className="font-semibold text-gray-700">{data.user_name}</span>!
        </p>
        ...
        {isUpcoming && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            <h2 className="text-lg font-bold text-gray-900 mb-1">Are you playing?</h2>
            ...
            {data.rsvp_status === "accepted" ? (
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="w-full py-3 text-sm font-medium text-gray-500 bg-gray-100 rounded-xl"
                >
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => handleRsvp("declined")}
                  disabled={submitting}
                  className="w-full py-3 text-sm font-medium text-gray-500 bg-gray-100 hover:bg-gray-200 rounded-xl"
                >
                  Can't make it
                </button>
              </div>
            ...
            <div className="space-y-3">
              {data.teams.map((team, idx) => (
                <div key={idx} className="bg-gray-50 rounded-lg p-3">
                  <p className="font-bold text-sm text-gray-800 mb-1">{team.team_name}</p>
        ...
        {isCompleted && data.notes && (
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 text-center">
            ...
            <p className="text-lg font-bold text-gray-900 mt-1">{data.notes}</p>
          </div>
        )}
        ...
        {isCompleted && data.voting_open && data.participants && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            <h2 className="text-lg font-bold text-gray-900 mb-1">Cast Your Votes</h2>
            ...
            {[
              ...
              const colorClasses = {
                yellow: { bg: "bg-yellow-50", border: "border-yellow-300", selected: "bg-yellow-100 border-yellow-400 font-semibold" },
                blue: { bg: "bg-blue-50", border: "border-blue-300", selected: "bg-blue-100 border-blue-400 font-semibold" },
                purple: { bg: "bg-purple-50", border: "border-purple-300", selected: "bg-purple-100 border-purple-400 font-semibold" },
              }[color];
              ...
              {data.awards.mvp && (
                <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-900">{data.awards.mvp.name}</p>
                  </div>
              ...
              {data.awards.xfactor && (
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-900">{data.awards.xfactor.name}</p>
                  </div>
              ...
              {data.awards.shaqtin && (
                <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-gray-900">{data.awards.shaqtin.name}</p>
                  </div>
